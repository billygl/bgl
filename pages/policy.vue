    ...
    >
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
          ...
          <p>
            Billy Grados built the Biblia Scanner app as
            a Free app. This SERVICE is provided by
            Billy Grados at no cost and is intended for
            use as is.
          </p> 
          <p>
            ...
            Biblia Scanner unless otherwise defined in this Privacy
            Policy.
